...
public class Assignment7 {
	...
	private static void createTask()
	{
		try {
			...
			Thread.sleep(500);
			obj.findElement(By.xpath("//div[@class=\"item createNewTask ellipsis\"]")).click();
			Thread.sleep(1000);
			obj.findElement(By.xpath("//*[@id=\"createTasksPopup_createTasksTableContainer\"]/table/tbody/tr[1]/td[1]/input")).sendKeys("testing");
            obj.findElement(By.id("createTasksPopup_commitBtn")).click();
		}catch(Exception e)
		{
			e.printStackTrace();
		}
